        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="trending__product">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <div class="section-title">
                                <h4>Trò chơi miễn phí</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="btn__all">
                                <a href="./app.php?id=0" class="primary-btn">Xem tất cả <span class="arrow_right"></span></a>
                            </div>
                        </div>
                    </div>
                    <!-- sản phẩm -->
                    <div class="row">
                        <?php
                        $sql="SELECT * FROM apps,categories WHERE apps.maloai = 1 and apps.theloai = categories.theloai and apps.traphiud = 0 LIMIT 0,3";
                        $res = $conn->query($sql);
                        if($res->num_rows>0){
                ...
                <div class="popular__product">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <div class="section-title">
                                <h4>Ứng dụng miễn phí</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="btn__all">
                                <a href="./app.php?id=1" class="primary-btn">Xem tất cả <span class="arrow_right"></span></a>
                            </div>
                        </div>
                    </div>
                    <!-- hiển thị ứng dụng-->
                    <div class="row">
                        <?php
                        $sql="SELECT * FROM apps,categories WHERE apps.maloai = 0 and apps.theloai = categories.theloai and apps.traphiud = 0 LIMIT 0,3";
                        $res = $conn->query($sql);
                        if($res->num_rows>0){
                            while ($row = $res->fetch_assoc()){
                                ?>
            ...
            ?>
                ...
                <div class="trending__product">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <div class="section-title">
                                <h4>Trò chơi tính phí</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="btn__all">
                                <a href="./app.php?id=2" class="primary-btn">Xem tất cả <span class="arrow_right"></span></a>
                            </div>
                        </div>
                    </div>
                    <!-- sản phẩm -->
                ...
                <div class="popular__product">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <div class="section-title">
                                <h4>Ứng dụng tính phí</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="btn__all">
                                <a href="./app.php?id=3" class="primary-btn">Xem tất cả <span class="arrow_right"></span></a>
                            </div>
                        </div>
                    </div>
                    <!-- hiển thị ứng dụng-->
