            ...
            <div class="col-lg-8">
                ...
                if($_GET['id'] == '0'){
                    ...
                    <div class="trending__product">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="section-title">
                                    <h4>Tất cả trò chơi miễn phí</h4>
                                </div>
                            </div>
                        </div>
                        <!-- sản phẩm -->
                        <div class="row">
                            <?php
                            $sql="SELECT * FROM apps,categories WHERE apps.maloai = 1 and apps.theloai = categories.theloai and apps.traphiud = 0";
                            $res = $conn->query($sql);
                            if($res->num_rows>0){
                    ...
                    <div class="popular__product">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="section-title">
                                    <h4>Tất cả Ứng dụng miễn phí</h4>
                                </div>
                            </div>
                        </div>
                        <!-- hiển thị ứng dụng-->
                        <div class="row">
                            <?php
                            $sql="SELECT * FROM apps,categories WHERE apps.maloai = 0 and apps.theloai = categories.theloai and apps.traphiud = 0";
                            $res = $conn->query($sql);
                            if($res->num_rows>0){
                                while ($row = $res->fetch_assoc()){
                                    ?>
                    ...
                    <div class="popular__product">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="section-title">
                                    <h4>Tất cả trò chơi tính phí</h4>
                                </div>
                            </div>
                        </div>
                        <!-- hiển thị ứng dụng-->
                    ...
                    <div class="popular__product">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="section-title">
                                    <h4>Tất cả ứng dụng tính phí</h4>
                                </div>
                            </div>
                        </div>
                        <!-- hiển thị ứng dụng-->
