...
//These must be at the top of your script, not inside a function
	...
	function sendActiveEmail($email, $token){
		...
		try{
			...
			$mail->Body    = "Nhấn <a href = 'http://localhost:8888/activate.php?email=$email&token=$token'> vào đây</a> để kích hoạt tài khoản";
	...
	function sendResetEmail($email, $token){
		...
		try{
			...
			$mail->Body    = "Nhấn <a href = 'http://localhost:8888/reset_password.php?email=$email&token=$token'> vào đây</a> để đổi mật khẩu";
