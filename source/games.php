        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                ?>
                    ...
                    <div class="row">
                    <?php
                    $sql2 = "SELECT * FROM apps WHERE apps.maloai = 1 and apps.theloai = '".$_GET["theloai"]."'";
                ...
                <?php
                    ...
                    <div class="row">
                        <?php
                        $sql="SELECT * FROM apps,categories WHERE apps.maloai = 1 and apps.theloai = categories.theloai ORDER BY apps.luottai DESC";
                        $res = $conn->query($sql);
                        if($res->num_rows>0){
